...
const SidePanel = (props ) => {
	...
	const { selectedTemplate, questionTemplateAnchor,  setQuestionTemplateAnchor, setShowModalAnchor, showFormsTableAnchor, setShowFormsTableAnchor} = props;
	return (
		<Box
			className="sidePanelPosition"
		>
			<IconButton
				onClick={() => setQuestionTemplateAnchor(!questionTemplateAnchor)}
			>
				<AddIcon/>
			</IconButton>
